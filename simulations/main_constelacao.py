...
def plot_i_vs_nu_segmentado(nu_deg: np.ndarray, inc_deg: np.ndarray, *,
    ...
    """
    Plota i versus ângulo orbital (ν ou u), em segmentos separados nos wraps 360->0,
    ...
    ax.set_xlabel("Ângulo orbital (ν ou u) [graus]")  # <— rótulo atualizado
...
ax.axis('equal')
plt.show()
# ----------------- Inclinação vs ângulo orbital (3 séries, cor fixa) -----------------
...
ax2.set_title("Inclinação vs Ângulo orbital (ν ou u)")  # <— título atualizado
ax2.legend()
plt.show()
